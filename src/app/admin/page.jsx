    ...
    const cards = [
        {
            ...
            href: "/admin/problem",
            color: "from-blue-500/20 to-blue-800/30 hover:from-blue-500/40 hover:to-blue-800/50",
        },
        {
            title: "Manage Users",
            ...
            href: "/admin/users",
            color: "from-green-500/20 to-green-800/30 hover:from-green-500/40 hover:to-green-800/50",
        },
        {
            ...
            color: "from-blue-500/20 to-purple-800/30 hover:from-purple-500/40 hover:to-purple-800/50",
        },
        {
        ...
        },
        {
            ...
            icon: <Sparkles className="w-8 h-8 text-purple-400" />,
            href: "/admin/upcoming",
            color: "from-purple-500/20 to-purple-800/30 hover:from-purple-500/40 hover:to-purple-800/50",
        },
    ];

    return (
        <div className="min-h-screen bg-[#0a0a0f] text-white flex flex-col items-center py-16 px-6">
