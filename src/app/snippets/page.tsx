          ...
          >
            <AnimatePresence mode="popLayout">
              {filteredSnippets.map(
                (snippet, idx) =>
                  idx < 3 && <SnippetCard key={snippet._id} snippet={snippet} />
              )}
            </AnimatePresence>
            {/* message to get pro */}
            <div className="col-span-full mt-8 p-6 bg-gradient-to-r from-yellow-400/10 to-orange-400/10 border border-yellow-400/20 rounded-xl text-center">
              <h2 className="text-xl font-semibold text-yellow-400 mb-2">
                Unlock All Snippets with Pro!
              </h2>
              <Link
                href="/pricing"
                className=" w-60 flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-amber-500/30 
              ...
              >
                ...
                <span className="text-amber-400 font-medium">Go Pro</span>
              </Link>
            </div>{" "}
          </motion.div>
